    ...
    elem.addEventListener('submit', function (event) {
      ...
      function postData() {
        return new _Promise(function (resolve, reject) {
          ...
          }; // Преобразование FormData в обычный объект и преобразование этого объекта в json формат
...
function tabs() {
  var tab = document.querySelectorAll('.info-header-tab'),
      ...
      tabContent = document.querySelectorAll('.info-tabcontent'); //hideTabContent
  ...
  hideTabContent(1); //showTabContent
